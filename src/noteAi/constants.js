...
export const DEFAULT_NOTE_AI_PREFS = Object.freeze({
  ...
  duplicates: true,
  organizeBoard: true,
  /** Phase 3: notes relationship graph subview */
  graph: true,
  /** Phase 3: contextual RAG chat over profile notes */
  ragChat: true,
});
...
/** Phase 3: RAG chat retrieval + generation. */
export const NOTE_AI_RAG_TOP_K = 6;
export const NOTE_AI_RAG_MIN_SCORE = 0.2;
export const NOTE_AI_RAG_MAX_QUESTION_CHARS = 600;
export const NOTE_AI_RAG_MAX_ANSWER_CHARS = 2500;
export const NOTE_AI_RAG_RATE_WINDOW_SEC = 60;
export const NOTE_AI_RAG_RATE_MAX_PER_WINDOW = 20;
